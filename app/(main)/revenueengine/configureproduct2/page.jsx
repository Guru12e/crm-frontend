...
export default function ConfigureProduct2Page() {
  ...
  return (
    <div className="w-full min-h-[70vh] relative p-4">
      <h1 className="text-3xl font-bold mb-2">Configure Products</h1>
      <p className="text-slate-500 mb-8">
        Customize product options, features, and configurations for your deals.
      </p>
